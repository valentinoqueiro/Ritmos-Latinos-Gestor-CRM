...
**Extensión (2026-07-10, segunda tanda): recordatorios y kanban.** Recordatorio de clase de prueba en las tarjetas (solo el día antes y el mismo día, con WhatsApp prellenado por plantilla configurable y marca «ya se le recordó» que se resetea al re-agendar), reapertura de leads perdidos hacia etapas abiertas (limpia el motivo; convertido sigue final), últimos 4 dígitos del teléfono en cada tarjeta, calendario nativo SOLO en la fecha de la clase de prueba (el resto del sistema sigue con fecha escrita), y fix de la superposición de tarjetas en la ficha por notas sin espacios. Detalle en CHANGELOG.
